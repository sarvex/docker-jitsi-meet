...
config.jaasTokenUrl = 'https://api-vo.cloudflare.jitsi.net/token-mapping';
config.jaasConferenceCreatorUrl = 'https://api-vo.cloudflare.jitsi.net/vmms-conference-mapper/v1/access/conference-creator';
config.webhookProxyUrl = 'https://api-vo.cloudflare.jitsi.net/webhook-proxy';
config.billingCounterUrl = 'https://api-vo.cloudflare.jitsi.net/billing-counter/v1/connection';
...
config.dialOutAuthUrl = 'https://api-vo.cloudflare.jitsi.net/phone-authorize';
config.dialOutRegionUrl = 'https://api-vo.cloudflare.jitsi.net/customer-configs/v1/outbound-destination';
config.peopleSearchUrl = 'https://api-vo.cloudflare.jitsi.net/v1/directory/search';
config.inviteServiceUrl = 'https://api-vo.cloudflare.jitsi.net/v1/meeting/invite';
config.recordingSharingUrl = 'https://api-vo.cloudflare.jitsi.net/jaas-recordings/link';
config.peopleSearchQueryTypes = ['user','conferenceRooms'];
config.sipInviteUrl = 'https://api-vo.cloudflare.jitsi.net/sip-jibri-gateway/jibris/invite';
config.jaasFeedbackMetadataURL = 'https://api-vo.cloudflare.jitsi.net/webhook-proxy/feedback';
